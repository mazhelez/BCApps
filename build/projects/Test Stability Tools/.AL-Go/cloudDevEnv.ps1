...
$GitHubHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/mazhelez/AL-Go/update-al-go-multiple-branches/Actions/Github-Helper.psm1' -folder $tmpFolder
$ALGoHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/mazhelez/AL-Go/update-al-go-multiple-branches/Actions/AL-Go-Helper.ps1' -folder $tmpFolder
DownloadHelperFile -url 'https://raw.githubusercontent.com/mazhelez/AL-Go/update-al-go-multiple-branches/Actions/Packages.json' -folder $tmpFolder | Out-Null
