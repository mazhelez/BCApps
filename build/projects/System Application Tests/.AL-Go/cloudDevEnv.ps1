...
$GitHubHelperUrl = 'https://raw.githubusercontent.com/mazhelez/AL-Go/fix-getdependencies/Actions/Github-Helper.psm1'
...
$ALGoHelperUrl = 'https://raw.githubusercontent.com/mazhelez/AL-Go/fix-getdependencies/Actions/AL-Go-Helper.ps1'
