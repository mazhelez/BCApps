...
$GitHubHelperUrl = 'https://raw.githubusercontent.com/mazhelez/AL-Go/fix-hardcoded-release/Actions/Github-Helper.psm1'
...
$ALGoHelperUrl = 'https://raw.githubusercontent.com/mazhelez/AL-Go/fix-hardcoded-release/Actions/AL-Go-Helper.ps1'
