...
$GitHubHelperUrl = 'https://raw.githubusercontent.com/mazhelez/AL-Go/fix-GetArtifacts/Actions/Github-Helper.psm1'
...
$ALGoHelperUrl = 'https://raw.githubusercontent.com/mazhelez/AL-Go/fix-GetArtifacts/Actions/AL-Go-Helper.ps1'
