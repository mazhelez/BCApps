...
$GitHubHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/mazhelez/AL-Go/add-settings-schema/Actions/Github-Helper.psm1' -folder $tmpFolder
$ALGoHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/mazhelez/AL-Go/add-settings-schema/Actions/AL-Go-Helper.ps1' -folder $tmpFolder
DownloadHelperFile -url 'https://raw.githubusercontent.com/mazhelez/AL-Go/add-settings-schema/Actions/Packages.json' -folder $tmpFolder | Out-Null
