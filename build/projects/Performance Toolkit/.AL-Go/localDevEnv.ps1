...
$GitHubHelperUrl = 'https://raw.githubusercontent.com/mazhelez/AL-Go/al-code-analysis/Actions/Github-Helper.psm1'
...
$ALGoHelperUrl = 'https://raw.githubusercontent.com/mazhelez/AL-Go/al-code-analysis/Actions/AL-Go-Helper.ps1'
