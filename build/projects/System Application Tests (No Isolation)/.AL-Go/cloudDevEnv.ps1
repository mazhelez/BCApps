...
$GitHubHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/mazhelez/AL-Go/custom-bccontainer/Actions/Github-Helper.psm1' -folder $tmpFolder
$ALGoHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/mazhelez/AL-Go/custom-bccontainer/Actions/AL-Go-Helper.ps1' -folder $tmpFolder
DownloadHelperFile -url 'https://raw.githubusercontent.com/mazhelez/AL-Go/custom-bccontainer/Actions/Packages.json' -folder $tmpFolder | Out-Null
